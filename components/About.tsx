...
export default function About() {
  return (
    <section
      id="about"
      className="bg-surface-light px-6 py-16 dark:bg-surface-dark/50 lg:px-40"
    >
      <div className="mx-auto flex max-w-[700px] flex-col items-center text-center">
        <div className="relative mb-6 h-24 w-24 overflow-hidden rounded-full border-4 border-white shadow-lg dark:border-gray-800">
          <Image
            src="/images/Mostafa.Gaber.jpg"
            alt="Portrait of Mostafa smiling"
            fill
            className="object-cover"
          />
        </div>
        <h2 className="mb-4 text-2xl font-bold text-text-main dark:text-white">
          Hi, I'm Mostafa.
        </h2>
